  ...
  "mcpServers": {
    "memos-api-mcp": {
      ...
      "env": {
        ...
        "MEMOS_CHANNEL": "where-are-you-seeing-this-document"
      }
    }
  }
}
...
- `env`: Environment variables
  ...
  - `MEMOS_CHANNEL`: The site where are you seeing this document. Candidate values: `MODELSCOPE`, `MCPSO`, `MCPMARKETCN`, `MCPMARKETCOM`, `GLAMA`, `PULSEMCP`, `MCPSERVERS`,`MEMOS`(meaning the MemOS official website), `GITHUB`(meaning this README file)
